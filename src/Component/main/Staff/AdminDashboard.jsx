    ...
    <div className="flex min-h-screen bg-black text-white">
      ...
      <aside className="w-64 border-r border-zinc-800 p-6">
        ...
        <nav className="space-y-4">
          ...
          <Link to="staff-manage" className="block text-sm hover:text-[#E2B747]">Staff Management</Link>
          <Link to="staff-manage" className="block text-sm hover:text-[#E2B747]">Staff Detailed</Link>
          <Link to="settings" className="block text-sm hover:text-[#E2B747]">Settings</Link>
        </nav>
      </aside>
